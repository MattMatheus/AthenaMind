...
- branch: dev
- story_path: backlog/engineering/done/STORY-20260223-embedding-retrieval-via-ollama.md
- idea_id: direct
- adr_refs: [ADR-0005, ADR-0012]

## Diff Inventory
- A backlog/engineering/done/HANDOFF-STORY-20260223-embedding-retrieval-via-ollama.md
- A backlog/engineering/done/QA-RESULT-STORY-20260223-embedding-retrieval-via-ollama.md
- A backlog/engineering/done/STORY-20260223-embedding-retrieval-via-ollama.md
- A docker-compose.ollama.yml
- A internal/retrieval/embedding.go
- A internal/retrieval/index_embedding.go
- D backlog/engineering/active/STORY-20260223-embedding-retrieval-via-ollama.md
- M backlog/engineering/active/README.md
- M cmd/memory-cli/commands.go
- M docs/cli/commands.md
- M docs/cli/examples.md
