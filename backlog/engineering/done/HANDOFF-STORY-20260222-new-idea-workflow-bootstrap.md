...
## What Changed
- Added intake validation command `/Users/foundry/Source/orchestrator/AthenaMind/scripts/validate_intake_items.sh`.
- Added doc-test wrapper `/Users/foundry/Source/orchestrator/AthenaMind/scripts/test_intake_validation.sh` and wired it into `/Users/foundry/Source/orchestrator/AthenaMind/scripts/run_doc_tests.sh`.
...
- Added PM failure-handling instructions in:
  - `/Users/foundry/Source/orchestrator/AthenaMind/prompts/active/pm-refinement-seed-prompt.md`
  - `/Users/foundry/Source/orchestrator/AthenaMind/backlog/architecture/INTAKE_REFINEMENT_GUIDE.md`
...
## Test Updates Made
- Added `scripts/test_intake_validation.sh` and integrated it into canonical docs test run.
