...
1. A concise operator workflow doc exists.
   - Evidence: `OPERATOR_DAILY_WORKFLOW.md`
2. It references `launch_stage.sh` and required prompts.
   - Evidence: workflow doc references `scripts/launch_stage.sh` and active stage prompts.
...
- Relevant checks: `scripts/test_founder_operator_workflow.sh`
- Result: PASS
