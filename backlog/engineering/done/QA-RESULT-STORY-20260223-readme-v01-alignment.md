...
2. README avoids unimplemented feature claims (FAISS, Podman, SQLite, embeddings, cloud) unless marked future.
   - Evidence: `scripts/test_readme_v01_alignment.sh` forbidden-term assertions pass.
3. Vision content is preserved in `docs/product/VISION.md`.
   - Evidence: `docs/product/VISION.md` exists and linked from README.
...
5. README links phased implementation plan.
   - Evidence: `README.md` links `research/roadmap/PHASED_IMPLEMENTATION_PLAN_V01_V03.md`.
