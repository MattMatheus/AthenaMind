...
1. A QA rubric doc exists with deterministic pass/fail criteria.
   - Evidence: `backlog/QA_REGRESSION_RUBRIC.md`
2. Priority mapping rules align with `BUG_TEMPLATE.md`.
   - Evidence: rubric `P0-P3` mapping aligns with `backlog/intake/BUG_TEMPLATE.md` definitions.
...
- Relevant checks: `scripts/test_qa_regression_rubric.sh`
- Result: PASS
