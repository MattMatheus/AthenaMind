...
1. `SCN-SEM-01` precision_at_3 improves and no materially incorrect recall is observed.
   - Evidence: `work-system/metrics/DOGFOOD_SCENARIO_RUN_2026-02-22-HARDENING.md` reports `precision_at_3 = 3/3 = 100%` and `wrong_memory_recall_rate = 0/4 = 0%`.
...
3. Updated dogfood run artifact records before/after KPI comparison.
   - Evidence: hardening run includes explicit baseline-vs-hardening deltas against `work-system/metrics/DOGFOOD_SCENARIO_RUN_2026-02-22.md`.
