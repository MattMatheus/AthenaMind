...
## Active Sequence
1. `STORY-20260223-sqlite-index-store.md` - starts v0.2 storage evolution once v0.1 queue-critical work is in motion.
2. `STORY-20260223-embedding-retrieval-via-ollama.md` - follows SQLite foundation for v0.2 retrieval-quality upgrade.
