...
## Context
`research/architecture/MVP_CONSTRAINTS_V01.md` defined constraint domains and required keys but left operational targets open, which blocked deterministic implementation sequencing and QA.
...
Owner:
- Operational owner for constraint policy: `personas/SRE - Nia.md`
