...
- Stage launcher (`scripts/launch_stage.sh`) enforces branch safety and emits scoped seed prompts
...
### Sprint Sequence (8 stories created in backlog/engineering/intake/)
...
2. `STORY-20260223-add-ci-pipeline` — GitHub Actions running `go test ./...` + `scripts/run_doc_tests.sh` on push to dev
3. `STORY-20260223-readme-v01-alignment` — rewrite README to reflect v0.1 reality, move vision to docs/product/VISION.md
...
## 3. Product Vision (captured in research/product/PRODUCT_VISION_V2.md)
...
1. `research/product/PRODUCT_VISION_V2.md` — long-term product vision, explicitly marked out-of-scope for v0.1
2. `backlog/engineering/intake/STORY-20260223-split-main-go-into-packages.md`
3. `backlog/engineering/intake/STORY-20260223-add-ci-pipeline.md`
4. `backlog/engineering/intake/STORY-20260223-readme-v01-alignment.md`
5. `backlog/engineering/intake/STORY-20260223-agent-bootstrap-protocol.md`
6. `backlog/engineering/intake/STORY-20260223-episode-writeback.md`
7. `backlog/engineering/intake/STORY-20260223-launch-stage-memory-integration.md`
8. `backlog/engineering/intake/STORY-20260223-sqlite-index-store.md`
9. `backlog/engineering/intake/STORY-20260223-embedding-retrieval-via-ollama.md`
...
1. Run `./scripts/launch_stage.sh pm` to have PM refinement rank intake stories into active queue.
