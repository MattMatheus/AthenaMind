...
- Pain points:
  - Both `backlog/architecture/active` and `backlog/engineering/active` are empty.
...
- Architecture/ADR intake candidates:
  - `backlog/architecture/intake/ARCH-20260222-phase-boundary-rebaseline-v01-v03.md`
