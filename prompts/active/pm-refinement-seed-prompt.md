...
7. Update `prompts/active/next-agent-seed-prompt.md` only if special launch instructions are needed.
8. Commit refinement outputs and backlog state changes with an appropriate message.
