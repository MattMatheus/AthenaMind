...
- In:
  ...
  - Move the original vision content to `knowledge-base/product/VISION.md` (preserve, do not delete).
  - Link from README to the phased plan (`product-research/roadmap/PHASED_IMPLEMENTATION_PLAN_V01_V03.md`) for future direction.
...
3. Original vision content preserved in `knowledge-base/product/VISION.md`.
