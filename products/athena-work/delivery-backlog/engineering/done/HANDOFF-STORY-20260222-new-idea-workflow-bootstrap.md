...
## What Changed
- Added intake validation command `<repo>/tools/validate_intake_items.sh`.
- Added doc-test wrapper `<repo>/tools/test_intake_validation.sh` and wired it into `<repo>/tools/run_doc_tests.sh`.
