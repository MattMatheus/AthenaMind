...
1. Harness produces deterministic metric outputs from pinned evaluation inputs.
   - Evidence: `/Users/foundry/Source/orchestrator/AthenaMind/cmd/memory-cli/main.go` implements `evaluate` with pinned references and deterministic output.
...
3. Tests cover fallback determinism and required response metadata.
   - Evidence: `/Users/foundry/Source/orchestrator/AthenaMind/cmd/memory-cli/main_test.go` includes deterministic fallback and response metadata completeness tests.
