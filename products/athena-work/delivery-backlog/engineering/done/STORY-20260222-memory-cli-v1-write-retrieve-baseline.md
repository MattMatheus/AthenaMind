...
## Problem Statement
- We need the first functional memory interface that can write and retrieve stage-prompts/instructions from repo-local files using semantic lookup, with review-controlled mutation workflows.
...
## Dependencies
- `delivery-backlog/architecture/done/ARCH-20260222-file-memory-cli-v1-architecture.md`
