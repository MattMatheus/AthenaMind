...
1. v0.1 goals and metric target bands are documented.
   - Evidence: `product-research/decisions/ADR-0008-v01-goals-and-scorecard-target-bands.md`
...
3. A decision record is created or updated and referenced from planning docs.
   - Evidence:
     - `knowledge-base/process/PM-TODO.md` references ADR-0008 completion.
     - `product-research/roadmap/RESEARCH_BACKLOG.md` references ADR-0008.

## Test and Regression Validation
- Executed: `tools/test_goals_scorecard_v01.sh`
...
- No blocking defects were identified and QA checks passed, so the story is transitioned from `delivery-backlog/qa/` to `delivery-backlog/done/` per QA directive.
