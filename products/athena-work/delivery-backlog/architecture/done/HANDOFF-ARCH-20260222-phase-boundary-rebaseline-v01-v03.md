...
- `product-research/architecture/MODULE_BOUNDARIES_V01.md`
- `product-research/architecture/ARCHITECTURE_BASELINE_MAP_V01.md`
- `delivery-backlog/architecture/qa/ARCH-20260222-phase-boundary-rebaseline-v01-v03.md`
...
- `tools/run_doc_tests.sh` -> FAIL (program board queue counts stale before state sync)
- `tools/validate_intake_items.sh` -> PASS
- `tools/run_doc_tests.sh` -> PASS (after queue-count sync and state transition updates)
