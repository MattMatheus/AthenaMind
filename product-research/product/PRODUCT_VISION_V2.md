...
## References
- Current v0.1 scope: `product-research/decisions/ADR-0007-memory-layer-scope-refinement.md`
- Competitive positioning: `product-research/competitive/COMPETITIVE_POSITIONING_AND_DIFFERENTIATION_MEMO_2026-02-22.md`
- Phased plan: `product-research/roadmap/PHASED_IMPLEMENTATION_PLAN_V01_V03.md`
- North star metrics: `product-research/decisions/ADR-0002-north-star-and-success-metrics.md`
- Governance model: `product-research/decisions/ADR-0006-governance-and-hitl-policy.md`
