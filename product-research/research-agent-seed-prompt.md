...
- **Backlog Item:** `product-research/roadmap/RESEARCH_BACKLOG.md` -> `Now` item 1: Program state consistency and release-checkpoint adoption.
...
1. Truncate and rewrite `product-research/handoff.md` with only:
   - What was produced
   - Why those outputs matter now
   - Validation performed
   - Open questions for next cycle
   - Recommended next backlog item
2. Update `product-research/roadmap/RESEARCH_BACKLOG.md` to reflect completion/progression.
3. Update this file (`product-research/research-agent-seed-prompt.md`) so `Primary Task` points to the next research cycle item.
