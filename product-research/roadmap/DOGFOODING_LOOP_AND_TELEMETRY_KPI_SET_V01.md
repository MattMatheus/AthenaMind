...
## Purpose
Translate `product-research/ingest/memory-best-practices.md` into a product + engineering operating loop that is compatible with AthenaMind v0.1 memory-layer scope.
...
1. Apply baseline priorities from `product-research/roadmap/MEMORY_BEST_PRACTICES_RUBRIC_V01.md`.
2. Define the initial 3 to 5 scenarios and owners.
3. Add telemetry fields to current memory CLI/session traces.
4. Publish first KPI snapshot using `operating-system/metrics/KPI_SNAPSHOT_TEMPLATE.md`.
