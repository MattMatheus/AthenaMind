...
template="$root_dir/work-system/metrics/KPI_SNAPSHOT_TEMPLATE.md"
snapshot="$root_dir/work-system/metrics/KPI_SNAPSHOT_2026-02-22_BASELINE.md"
program_board="$root_dir/research/roadmap/PROGRAM_STATE_BOARD.md"
founder_snapshot="$root_dir/research/roadmap/FOUNDER_SNAPSHOT.md"
...
doc_assert_contains "$program_board" "work-system/metrics/KPI_SNAPSHOT_2026-02-22_BASELINE.md" "Program board references KPI baseline snapshot"
doc_assert_contains "$founder_snapshot" "work-system/metrics/KPI_SNAPSHOT_2026-02-22_BASELINE.md" "Founder snapshot references KPI baseline snapshot"
