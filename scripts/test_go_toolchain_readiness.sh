...
howto_doc="$root_dir/docs/how-to/GO_TOOLCHAIN_SETUP.md"
workflow_doc="$root_dir/OPERATOR_DAILY_WORKFLOW.md"

doc_test_init

doc_assert_exists "$root_dir/scripts/check_go_toolchain.sh" "Go toolchain preflight script exists"
...
doc_assert_contains "$howto_doc" "scripts/check_go_toolchain.sh" "How-to references toolchain preflight command"
doc_assert_contains "$howto_doc" "go test ./..." "How-to references canonical Go test command"
doc_assert_contains "$workflow_doc" "scripts/check_go_toolchain.sh" "Daily workflow includes Go toolchain preflight"
