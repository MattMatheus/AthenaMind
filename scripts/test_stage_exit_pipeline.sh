...
doc_assert_contains "$root_dir/prompts/active/qa-agent-seed-prompt.md" "run_observer_cycle.sh" "QA prompt enforces observer step"
doc_assert_contains "$root_dir/docs/process/STAGE_EXIT_GATES.md" "Cycle Closure Gate (Observer + Commit)" "Stage exits include observer closure gate"
